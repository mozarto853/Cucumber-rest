...
public class LoginDemoSteps {
    ...
    public void user_enters_username_and_password() {
        ...
        System.out.println("Inside Step- user enters text in name");
        driver.findElement(By.id("name")).sendKeys("Estelle Bright");
        System.out.println("Inside Step- user enters text in password");
